...
function createProductCard(product) {
    ...
    const ratingData = window.ratingManager ? window.ratingManager.getProductRating(product.id) : null;
                    ...
                    ${hasRealRatings ? `
                        <div class="rating mb-2">
                            <div class="d-flex align-items-center">
                                ...
                                <small class="text-muted">
                                    (${ratingData.averageRating.toFixed(1)}) • ${ratingData.totalRatings} ${ratingData.totalRatings === 1 ? 'review' : 'reviews'}
                                </small>
                            </div>
                        </div>
                    ` : `
                        <div class="rating mb-2">
                            <small class="text-muted">
                                <i class="fas fa-star-o me-1"></i>No reviews yet
                            </small>
                        </div>
                    `}
                    ${stockStatus.html}
